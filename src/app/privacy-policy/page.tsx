  ...
  return (
    <NavbarLayout
      render={(mainProps) => (
        <>
          <Head>
            <title>{"Snowbound Labs: Privacy Policy"}</title>
            <meta name="description" content="Snowbound Labs Privacy Policy" />
          </Head>
          <Wrapper>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  {
                    "(referred to as either 'the Company', 'We', 'Us', or 'Our' in this Agreement) refers to Snowbound Labs LLC, 2034 W 31st Ave Unit B Denver, CO 80211."
                  }
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  ...
                  {"refers to Snowbound Labs, accessible from"}
                  <a
                    href="http://www.snowboundlabs.com/"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    {"http://www.snowboundlabs.com/"}
                  </a>
                </p>
              </li>
              <li>
            ...
            <p>
              {
                "Your information, including Personal Data, is processed at the Company's operating offices and in any other places where thparties involved in the processing are located. It means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction."
              }
            </p>
            <p>
              {
            ...
            <ul>
              <li>{"By email: contact@snowboundlabs.com"}</li>
            </ul>
          </Wrapper>
        </>
      )}
