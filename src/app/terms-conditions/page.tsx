...
//   title: "Snowbound Labs: Terms and Conditions",
//   description: "Snowbound Labs Terms and Conditions",
// };

export default function TermsAndCondition(props: any) {
  return (
    <NavbarLayout
      render={(mainProps) => (
        <>
          <Head>
            <title>{"Snowbound Labs: Terms and Conditions"}</title>
            <meta
              name="description"
              content="Snowbound Labs Terms and Conditions"
            />
          </Head>
          <Wrapper>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  <a
                    href="http://snowboundlabs.com/ "
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    {"http://snowboundlabs.com/"}
                  </a>
                </p>
              </li>
              <li>
